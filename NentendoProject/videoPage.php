...
The News of Nintendo Switch
</h2>
</p>

<div class="type" data-in-view>
            <a href="https://www.nintendolife.com/news/2020/06/animal_crossing_new_horizons_adds_cute_summer_and_winter-solstice_seasonal_items">
            <img src ="New1.jpg" alt ="Beatiful view" width="320" height="320" style="margin-left:10%"/> 
            <label style="text-align: center;margin-left:10%; booder:20px;color:red">
                <h3>Animal Crossing:New Horizon Adds Cute Summer and ... !</h3>
               </label>  
               </div>

             <div class="type" data-in-view>
            <a href="http://www.nintendolife.com/news/2020/06/here_are_launch_patch_notes_for_clubhouse_games_51_worldwide_classics">
            <img src ="New2.jpg" alt ="Beatiful view" width="320" height="320" style="margin-left:10%"/> 
            <label style="text-align: center;margin-left:10%; booder:20px;color:red">
              <h3>Here are Launch Patch Notes for Clubhouse Game ...!</h3>
               </label>  
               </div>

               <div class="type" data-in-view>
            <a href="http://www.nintendolife.com/news/2020/06/video_12_exciting_new_games_coming_to_nintendo_switch_in_june">
            <img src ="New3.jpg" alt ="Beatiful view" width="320" height="320" style="margin-left:10%"/> 
            <label style="text-align: center;margin-left:10%; booder:20px;color:red">
                <h3>Video of 12 Exciting New Game Coming to ...!</h3>
               </label>  
               </div>
